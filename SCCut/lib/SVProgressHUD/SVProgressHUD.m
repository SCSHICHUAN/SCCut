...
+ (void)showWithStatus:(NSString*)status {
    [self setForegroundColor:[BlackColor colorWithAlphaComponent:0.1f]];
...
- (void)fadeInEffects {
    UIColor *backgroundColor = self.backgroundColorForStyle;
...
//        self.hudView.effect = blurEffect;
        ...
        backgroundColor = [self.backgroundColorForStyle colorWithAlphaComponent:0.35f];
    }
    
    self.hudView.backgroundColor = backgroundColor;
    self.hudView.contentView.backgroundColor = [UIColor clearColor];
